    ...
    return (
        <div>
            <div className='custom-bg py-5 flex justify-between items-center'>
                ...
                <h6 className='text-base font-normal md:mr-14'><span className='text-gray-700'>Home</span> &rarr; Management</h6>
            </div>
            <div className='mt-5'>
                ...
                <div className='mt-12 bg-[#EDEDED] pb-14'>
                    ...
                    <div className='md:grid md:w-10/12 mx-auto grid-cols-3 gap-24 mt-24'>
                        <div className='border border-gray-600 text-center rounded-lg'>
                            <div className='border-t-0 w-36 h-36 relative -top-16  -right-20 custom-border'>
                                <img className='rounded-full w-36 h-36' src={woman} alt="" />
                            </div>
                            <h5 className='text-xl font-semibold -mt-10'>Afuwape J. Abiodun </h5>
                            <h6>consectetur adipiscing</h6>
                            <div className='mt-4 pb-5'>
                                <button className='mr-3'><BsFacebook></BsFacebook></button>
                                <button className='mr-3'><BsInstagram></BsInstagram></button>
                                <button><BsWhatsapp></BsWhatsapp></button>
                            </div>
                        </div>
                        <div className='border border-gray-600 relative text-center rounded-lg'>
                            <div className='border-t-0 w-36 h-36 relative -top-16  -right-20 custom-border'>
                                <img className='rounded-full w-36 h-36' src={woman} alt="" />
                            </div>
                            <h5 className='text-xl -mt-10 font-semibold '>Afuwape J. Abiodun </h5>
                            <h6>consectetur adipiscing</h6>
                            <div className='mt-4 pb-5'>
                                <button className='mr-3'><BsFacebook></BsFacebook></button>
                                <button className='mr-3'><BsInstagram></BsInstagram></button>
