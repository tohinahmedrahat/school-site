...
const Contact = () => {
    return (
        <div>
            ...
            <div className='mt-8'>
                <h2 className='text-center font-bold text-3xl text-[#22343D]'>Contact & Find us</h2>
                <hr className='w-[100px] mx-auto mt-3 border-b-2 border-[#22343D]' />
                <div className='md:w-11/12 mx-auto md:grid grid-cols-3 mt-14 '>
                    <div className='py-7 pl-5 bg-[#C4C4C4] rounded-l-lg'>
                        <h3 className='text-3xl font-bold uppercase'>Contact Info</h3>
                        <p className='text-xl font-normal my-7 text-gray-600'>You can always reach us via following contact details. We will give our best to reach you as possible.</p>
                        <div className='flex'>
                        ...
                        <div className='flex'>
                            ...
                            <div className='text-xl font-medium ml-3'>
                                <h6>4 law castle agbole aro opp. fidelity bank omida, abeokuta.</h6>
                            </div>
                        </div>
                    </div>
                    <div className='col-span-2 '>
                        <iframe className='rounded-r-lg' title='map' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14576.539275765917!2d90.24205760016109!3d24.026310502944764!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755e6bfa5230ed7%3A0x5e7ac06ece1150f2!2sBaroipara!5e0!3m2!1sen!2sbd!4v1684909264117!5m2!1sen!2sbd" width="100%" height="100%" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
            ...
            <div className="custom-bg py-28 mt-12">
